...
async function init() {
  ...
  xhr.setRequestHeader("X-Naver-Client-Id", "E0sB7qAsMyoeAJs5wtQW"); //"MPF85hV_M_MgoJFe46Ms");
  xhr.setRequestHeader("X-Naver-Client-Secret", "1PFZQdjrBM"); //"uSvgQms2A1");
  xhr.send();
